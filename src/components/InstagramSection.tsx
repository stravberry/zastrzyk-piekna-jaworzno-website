...
const InstagramSection = () => {
  ...
  useEffect(() => {
    ...
    // Only add the script once we decide to load the embed
    ...
    return () => {
      // keep script for subsequent interactions
    };
  }, [shouldLoad]);
  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        {/* Instagram Feed Embed or Placeholder - Centered */}
          ...
          {shouldLoad ? (
            <div className={`w-full max-w-4xl mx-auto flex justify-center transition-opacity duration-300 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
              ...
              >
                <div style={{ padding: '16px' }}>
                  <a 
                    href="https://www.instagram.com/zastrzyk_piekna/" 
                    target="_blank" 
            ...
            <div className="w-full max-w-xl mx-auto">
              <div className="rounded-lg border bg-white p-6 text-center shadow-sm">
                <p className="text-gray-600 mb-4">Aby przyspieszyć stronę, wczytuję Instagram dopiero po kliknięciu.</p>
                <Button onClick={() => setShouldLoad(true)} className="bg-pink-500 hover:bg-pink-600 text-white">
                  <Instagram className="mr-2 h-4 w-4" /> Załaduj feed
                </Button>
              </div>
            </div>
          )}
...
// Add this to make TypeScript happy if it complains about the instgrm property
declare global {
  interface Window {
    instgrm?: {
      Embeds: {
