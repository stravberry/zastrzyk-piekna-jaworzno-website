...
const InstagramSection = () => {
  ...
  // This effect will inject the Instagram embed script when the component mounts
  useEffect(() => {
    ...
    if (!document.getElementById('instagram-embed-script')) {
      ...
      script.onload = () => {
        // Process any embeds already in the document
        if (window.instgrm) {
    ...
    return () => {
      // We don't actually remove the script as other components might still need it
    };
  }, []);
