...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <header className="relative bg-gradient-to-b from-pink-50/80 to-white py-16 md:py-28 overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative">
            <div className="aspect-square rounded-full bg-pink-100 absolute -top-10 -right-10 w-28 h-28 z-0 animate-pulse" aria-hidden="true"></div>
            <div className="aspect-square rounded-full bg-gold-100 absolute -bottom-5 -left-5 w-20 h-20 z-0 animate-pulse" aria-hidden="true"></div>
            <img 
